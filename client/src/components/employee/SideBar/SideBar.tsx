...
const SideBar = () => {
    ...
    return (
        <div className='lg:w-full lg:h-screen lg:bg-sidebar lg:col-span-2 lg:text-sm hidden lg:block'>
            ...
            <div className='ml-5 font-extralight bold'>general</div>
            <div className='flex-col items-center justify-evenly p-5'>
 
           
                    <div className='flex mb-2 shadow-sm hover:bg-slate-100 rounded-md cursor-pointer' >
                        <h3>#</h3>
                       
                            <Link href={`/thread/`}>
                                <p onClick={() => dispatch(currentChannel("hello"))} className='ml-2'>
                                  employees
                                </p>
                            </Link>
