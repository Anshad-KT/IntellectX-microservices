        ...
        <main>
            <Navbar />
                ...
                <div className="grid lg:grid-cols-2  lg:place-items-center h-screen">
                    ...
                    <div className='lg:my-2 lg:p-5 lg:w-3/4 lg:h-3/4 lg:ml-36 mt-10'>
                        ...
                        <div className="mt-10">
                            ...
                            <button className='text-center my-5 border w-96 h-12 text-white bg-primary border-gray-300 rounded-md'>Continue with email</button>
                ...
                <div className='hidden lg:w-3/4 lg:flex lg:items-center lg:justify-center lg:mb-32'>
                    <div>
                        <Image className=''
                            src="/landing-images/landing-1.png"
                            width={800}
                            height={800}
